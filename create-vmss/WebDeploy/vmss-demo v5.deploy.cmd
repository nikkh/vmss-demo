...
set _DeploySetParametersFile=%RootPath%vmss-demo v5.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%vmss-demo v5.zip" (
echo "%RootPath%vmss-demo v5.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%vmss-demo v5.deploy-readme.txt" (
...
start notepad "%RootPath%vmss-demo v5.deploy-readme.txt"
)
echo =========================================================
goto :eof
