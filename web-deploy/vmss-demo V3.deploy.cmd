...
set _DeploySetParametersFile=%RootPath%vmss-demo V3.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%vmss-demo V3.zip" (
echo "%RootPath%vmss-demo V3.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%vmss-demo V3.deploy-readme.txt" (
...
start notepad "%RootPath%vmss-demo V3.deploy-readme.txt"
)
echo =========================================================
goto :eof
