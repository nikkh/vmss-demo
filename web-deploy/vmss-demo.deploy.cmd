...
set _DeploySetParametersFile=%RootPath%vmss-demo.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%vmss-demo.zip" (
echo "%RootPath%vmss-demo.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%vmss-demo.deploy-readme.txt" (
...
start notepad "%RootPath%vmss-demo.deploy-readme.txt"
)
echo =========================================================
goto :eof
